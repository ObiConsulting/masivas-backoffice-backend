...
public class ArchivoControllerTest {
    ...
    void buscarArchivoDirectorio_exito() {
        ...
        doNothing().when(archivoService).logAuditoria(any(), any(), any(), any(), any(), any(), any(), any());
    ...
    void buscarDetalleMasivas_exito() {
        ...
        doNothing().when(detalleMasivasService).logAuditoria(any(), any(), any(), any(), any(), any(), any(), any());
