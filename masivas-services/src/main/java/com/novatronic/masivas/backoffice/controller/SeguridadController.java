...
public class SeguridadController {
    ...
    public ResponseEntity<MasivasResponse<CustomPaginate<String>>> permisos(@AuthenticationPrincipal UserContext userContext) {
        try {
            ...
            seguridadService.logEvento(respuesta.getMensaje());
            seguridadService.logAuditoria(null, Evento.EV_ACTUALIZA_CONFIG_SISTEMA, Estado.ESTADO_EXITO, userContext, ConstantesServices.ACCION_PERMISSION,
            ...
            seguridadService.logError(ConstantesServices.MENSAJE_ERROR_GENERICO, e);
            seguridadService.logAuditoria(null, Evento.EV_ACTUALIZA_CONFIG_SISTEMA, Estado.ESTADO_FRACASO, userContext, ConstantesServices.ACCION_PERMISSION,
    ...
    public ResponseEntity<MasivasResponse<Void>> cerrarSesion(@AuthenticationPrincipal UserContext userContext) {
        ...
        try {
            ...
            seguridadService.logEvento(respuesta.getMensaje());
            seguridadService.logAuditoria(userContext, Evento.EV_LOGOFF_USUARIO, Estado.ESTADO_EXITO, userContext, ConstantesServices.ACCION_LOGOUT,
                    respuesta.getMensaje(), ConstantesServices.RESPUESTA_OK_API);
            ...
            seguridadService.logError(ConstantesServices.MENSAJE_ERROR_GENERICO, e);
            seguridadService.logAuditoria(userContext, Evento.EV_LOGOFF_USUARIO, Estado.ESTADO_FRACASO, userContext, ConstantesServices.ACCION_LOGOUT,
                    ConstantesServices.MENSAJE_ERROR_GENERICO, ConstantesServices.CODIGO_ERROR_GENERICO);
    ...
    public ResponseEntity<MasivasResponse<LoginResponse>> cambiarClave(@RequestBody @Valid ChangePassRequest authRequest, @AuthenticationPrincipal UserContext userContext) {
        ...
        try {
            ...
            seguridadService.logEvento(respuesta.getMensaje());
            seguridadService.logAuditoria(authRequest, Evento.EV_ACTUALIZA_CONFIG_SISTEMA, Estado.ESTADO_EXITO, userContext, ConstantesServices.ACCION_CHANGE_PASSWORD,
                    respuesta.getMensaje(), ConstantesServices.RESPUESTA_OK_API);
            ...
            seguridadService.logError(ConstantesServices.MENSAJE_ERROR_GENERICO, e);
            seguridadService.logAuditoria(authRequest, Evento.EV_ACTUALIZA_CONFIG_SISTEMA, Estado.ESTADO_FRACASO, userContext, ConstantesServices.ACCION_CHANGE_PASSWORD,
                    ConstantesServices.MENSAJE_ERROR_GENERICO, ConstantesServices.CODIGO_ERROR_GENERICO);
